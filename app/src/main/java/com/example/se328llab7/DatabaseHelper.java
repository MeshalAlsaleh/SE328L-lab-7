...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String COL2 = "PRODUCT_NAMES";
    ...
    public void onCreate(SQLiteDatabase db) {
        String createTable = "CREATE TABLE " + TABLE_NAME +
                ...
                " PRODUCT_NAMES TEXT, PRODUCT_QUANTITY TEXT)";
    ...
    */
    ...
    public Cursor getSpecificResult(String productName){
        ...
        Cursor data = db.rawQuery("SELECT * FROM " + TABLE_NAME +" Where PRODUCT_NAMES=? ",new String[]{productName});
        return data;
    }
